    ...
    <ul class="nav-bar3" :class="[hide ? 'is-hide2' : 'not-hide2']">
        <div class="white-b">
          <!-- <back style="float:left;display:inline"/> -->
            <li @click="handleMenuSelect('Story')" :class="{ 'active': isActive('Story') }">动态</li>
            <li @click="handleMenuSelect('Video')" :class="{ 'active': isActive('Video') }">视频</li>
            <li @click="handleMenuSelect('Article')" :class="{ 'active': isActive('Article') }">小说</li>
