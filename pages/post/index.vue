...
export default {
    ...
    methods: {
        ...
        //     this.$axios.post(process.env.BASE_URL+''+ this.apiSlug, formData)
        //         .then((res) => {
        //                 if(res.data.status ==1) {
        //                     this.$alert(res.data.msg) 
        //                     if(this.uploadType ==6) {
        //                         if(res.data.data.papa_id) {
        //                             this.papa_id = res.data.data.papa_id
        //                         }
        //                         this.uploadFFMpeg()
        ...
        //             this.getQiniuToken()
        //             const observable = qiniu.upload(this.file, this.$refs.file.files[0].name.replace(/\.[^/.]+$/, ""), 'VekL15eaXQzTaXYHVIA_rk2YkrJBtXaYqhW48t0n:jnMv1aocwqNqkJnGsETlaJ4f3Eg=:eyJzY29wZSI6ImJhYnlzIiwiZGVhZGxpbmUiOjE1OTgwNzA0MzJ9')
        ...
        //                 let data = {type: self.uploadType, appid:1}
        ...
        //     let data = {
        //         appid: 1,
        //         type: this.ffmpegType,
        //         video_id: this.video_id,
        //         record_id: this.papa_id ? this.papa_id : this.blog_id
        //     }
        //     let encryptData = await this.encrypt(data)
        //     let formData = new FormData();
        //     formData.append("data", encryptData)
        //     this.$axios.post(process.env.BASE_URL+'my/ffmpeg_uploaded_video', formData)
        //         .then((res) => {
        //             })
        //             .catch((err) => {
        //                 console.log("get encrypt error")
